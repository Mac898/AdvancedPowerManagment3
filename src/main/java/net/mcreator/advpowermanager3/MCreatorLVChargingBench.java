...
public class MCreatorLVChargingBench extends Elementsadvpowermanager3.ModElement {
	@GameRegistry.ObjectHolder("advpowermanager3:lvchargingbench")
	public static final Block block = null;

	public MCreatorLVChargingBench(Elementsadvpowermanager3 instance) {
		super(instance, 1);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "advpowermanager3:tileentitylvchargingbench");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("advpowermanager3:lvchargingbench",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("lvchargingbench");
			setUnlocalizedName("lvchargingbench");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.lvchargingbench";
		}
		...
		public String getGuiID() {
			return "advpowermanager3:lvchargingbench";
		}
