...
public class MCreatorHVChargingBench extends Elementsadvpowermanager3.ModElement {
	@GameRegistry.ObjectHolder("advpowermanager3:hvchargingbench")
	public static final Block block = null;

	public MCreatorHVChargingBench(Elementsadvpowermanager3 instance) {
		super(instance, 3);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "advpowermanager3:tileentityhvchargingbench");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("advpowermanager3:hvchargingbench",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("hvchargingbench");
			setUnlocalizedName("hvchargingbench");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.hvchargingbench";
		}
		...
		public String getGuiID() {
			return "advpowermanager3:hvchargingbench";
		}
